...
def is_swap(player_score, opponent_score):
    ...
    player_tens = ((player_score - player_ones) / 10) % 10
    opponent_tens = ((opponent_score - opponent_ones) / 10) % 10
    player_difference = abs(player_ones - player_tens)
    opponent_difference = abs(opponent_ones - opponent_tens)
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    score_max = average(1, dice)
    for i in range(1, 11):
        score_new = average(i, dice)

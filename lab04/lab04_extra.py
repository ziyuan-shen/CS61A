...
def put_piece(board, max_rows, column, player):
    ...
    if row == -1:
        ...
        row_new = replace_elem(board[row], column, player)
        board_new = replace_elem(board, row, row_new)
        return row, board_new
